        ...
        for (int dir = -1; dir <= 1; dir += 2) {
            ...
            while (tablero.getCelda(x, y) != null && tablero.getFicha(x, y) != null) {
                ...
                if (dir == 1 || (x != xx || y != yy)) {
                    ...
                    if(tablero.getCelda(x,y).estaBloqueada()) hayBloqueada = true;
                    
                    if(tablero.getCelda(x, y).isDobleTripleLetra()) puntosFicha *= tablero.getCelda(x,y).getBonificacion().getMultiplicador();
                    if(tablero.getCelda(x, y).isDobleTriplePalabra()) doblePalabra = true;
