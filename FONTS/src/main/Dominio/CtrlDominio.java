...
public class CtrlDominio {
     ...
     public void iniciarPartida(int modo, String nombre1, String nombre2, List<String> lineasArchivo, List<String> lineasArchivoBolsa)  {
      List<String> players = new ArrayList<>();
      if(nombre1 != "") players.add(nombre1);
      if(nombre2 != "") players.add(nombre2);
