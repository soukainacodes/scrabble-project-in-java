    ...
    public static void main(String[] args) {
       /*  try {
          ...
          dawg.agregarPalabra("HOLA");
            ...
            // Y si tienes un método para buscar un prefijo:
            boolean existe = dawg.buscarPrefijo("hol");
            System.out.println("El prefijo 'hol' " + (existe ? "existe" : "no existe") + " en el DAWG.");
            
            // Aquí puedes agregar más pruebas que hagan que se lancen excepciones o casos extremos.
