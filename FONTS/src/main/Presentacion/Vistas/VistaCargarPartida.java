...
public class VistaCargarPartida extends JPanel {
    ...
    public VistaCargarPartida() {
        ...
        setPreferredSize(new Dimension(700, 450)); // Consistente con VistaRecursos
    }
    
private JPanel createTitlePanel() {
    JPanel panel = new JPanel(new FlowLayout(FlowLayout.CENTER));
    panel.setBackground(APP_BG_COLOR);
    // Añadir más espacio vertical (padding) para que el título baje un poco
    ...
    for (int i = 0; i < letras.length; i++) {
        ...
        // Reducir tamaño de fuente y fichas
        letra.setFont(new Font("Arial Black", Font.BOLD, 24)); // Más pequeño
        letra.setForeground(Color.WHITE);
        letra.setHorizontalAlignment(SwingConstants.CENTER);
        letra.setPreferredSize(new Dimension(35, 35)); // Más pequeño
        letra.setMaximumSize(new Dimension(35, 35)); // Más pequeño
        ...
        // Reducir el espacio entre letras
        if (i < letras.length - 1 && !letras[i+1].equals(" ")) 
            fichasPanel.add(Box.createHorizontalStrut(3)); // Menos espacio
    }
